...
ApplicationInputManager& ApplicationInputManager::getInstance()
{
    static ApplicationInputManager instance;
    return instance;
}

ApplicationInputManager::ApplicationInputManager()
{
...
void ApplicationInputManager::actionEventCallback(ActionEvent pEvent)
{
    callForSdlinatorEvents(pEvent);
}

void ApplicationInputManager::keyboardEventCallback(KeyboardEvents pEvent)
{
    callForKeyboardEvents(pEvent);
}

void ApplicationInputManager::mouseEventCallback(MouseEvents pEvent)
{
    callForMouseEvents(pEvent);
}

void ApplicationInputManager::addSdlinatorCallback(Application *const object, void (Application::* const func)(ActionEvent))
{
...
void ApplicationInputManager::addKeyboardCallback(Application *const object, void (Application::* const func)(KeyboardEvents))
{
    using namespace std::placeholders;
...
void ApplicationInputManager::addMouseCallback(Application *const object, void (Application::* const func)(MouseEvents))
{
    using namespace std::placeholders;
...
void ApplicationInputManager::removeFromAllListeners(const int pCallbackId)
{
...
void ApplicationInputManager::removeActionCallback(const int pCallbackId)
{
...
void ApplicationInputManager::removeKeyboardCallback(const int pCallbackId)
{
...
void ApplicationInputManager::removeMouseCallback(const int pCallbackId)
{
...
void ApplicationInputManager::callForSdlinatorEvents(ActionEvent pEvent)
{
...
void ApplicationInputManager::callForKeyboardEvents(KeyboardEvents pEvent)
{
...
void ApplicationInputManager::callForMouseEvents(MouseEvents pEvent)
{
